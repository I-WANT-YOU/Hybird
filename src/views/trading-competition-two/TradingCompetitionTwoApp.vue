  ...
  <div class="trading-competition-two">
    ...
    <div class="trading-competition-two-fund-wraps">
      ...
      <div class="trading-competition-two-funds">
        <FundCardApp v-for="fund in featuredProducts" :fundDetail="fund" :key="fund.id" />
      </div>
    </div>
...
import FundCardApp from './components/FundCardApp.vue';
...
export default {
  ...
  async mounted() {
    ...
    try {
      ...
      this.tableData = this.rankingAll;
